...
(custom-set-faces
  ...
  ;; Your init file should contain only one such instance.
  ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "black" :foreground "#00ff00" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 100 :width normal :foundry "unknown" :family "DejaVu Sans Mono"))))
 '(font-lock-constant-face ((t (:foreground "#5555FF"))))
 '(font-lock-preprocessor-face ((t (:foreground "#8888FF"))))
 ...
 '(stripes-face ((t (:background "#050505")))))

...
(("poc-oliver"
 ...
 (position . 220))
("riverdale-chef"
 (filename . "~/code/riverdale-chef/")
 (front-context-string . "Berksfile\n  -rw-")
 (rear-context-string . "47 Jul  6 11:01 ")
 (position . 221))
("riverdale"
 (filename . "~/.riverdale/")
...
("thoughtstream-message_bus"
 ...
 (position . 236))
("thoughtstream-health"
 (filename . "~/bluescape/thoughtstream-health/")
 (front-context-string . "app\n  drwxrwxr-x")
 (rear-context-string . "96 Oct 27 14:35 ")
 (position . 228))
("thoughtstream-socket_bridge"
 (filename . "~/bluescape/thoughtstream-socket_bridge/")
 (front-context-string)
 (rear-context-string . "t 27 14:35 spec\n")
 (position . 874))
...
("emux"
 (filename . "~/code/emux/")
 (front-context-string . "emux-base.el\n  -")
 (rear-context-string . "013-01-02 23:37 ")
 (position . 223))
)
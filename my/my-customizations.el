...
>> " "" "
 ...
 '(linum-delay t)
 '(linum-eager t)
 '(magit-branch-arguments (quote ("--track --set-upstream")))
...
(custom-set-faces
 ...
 '(magit-diff-added ((t (:foreground "#0f0"))))
 '(magit-diff-added-highlight ((t (:background "#111" :foreground "#0f0"))))
 '(magit-diff-context ((t (:foreground "#444"))))
 '(magit-diff-context-highlight ((t (:background "#111" :foreground "#333"))))
 '(magit-diff-del ((t (:foreground "#F00"))))
 '(magit-diff-removed ((t (:foreground "#f33"))))
 '(magit-diff-removed-highlight ((t (:background "#111" :foreground "#f33"))))
 '(magit-item-highlight ((t (:background "#002"))))
 '(magit-section-highlight ((t (:background "#101"))))
